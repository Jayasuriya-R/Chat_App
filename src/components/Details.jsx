  ...
  return (
    <div className="pb-2 px-1">
      ...
      <div>
        ...
        <button className="bg-blue-400 text-white w-full text-xs px-2 py-[4px] rounded-xs cursor-pointer hover:bg-blue-500" onClick={()=>dispatch(removeuser(),addSelectedUser(null))}> Log Out</button>
        </div>
      </div>
    </div>
  );
